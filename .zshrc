...
alias goprecommit="golangci-lint run --new-from-rev=HEAD~1"
alias ..="cd .."
alias goimp="git ssb | grep -E -i '\.go' | xargs goimports -w"
...
export RANGER_FURY_LOCATION=/Users/diesalgado/.fury #Added by Fury CLI
export RANGER_FURY_VENV_LOCATION=/Users/diesalgado/.fury/fury_venv #Added by Fury CLI

# Added by Fury CLI installation process
declare FURY_BIN_LOCATION="/Users/diesalgado/.fury/fury_venv/bin" # Added by Fury CLI installation process
